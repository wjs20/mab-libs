...
class RandomizationStrategy:
    ...
    def __init__(
        self, position_residue_mapping: Dict, n: Union[None, int] = None
    ) -> None:
        """
        Args:
        ...
        self.n = n if n is not None else len(position_residue_mapping)
    ...
    def get_mutations(self) -> Iterator[Tuple[Mutation]]:
        ...
        """
        grouped_mutations = self._group_by_position(self._get_position_residue_pairs())
        return it.chain.from_iterable(
